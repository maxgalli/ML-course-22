...
if __name__ == "__main__":
    ...
    layer_ap = layers.Dense(700, activation="relu", name="ap3")(layer_ap)
    layer_ap = layers.Dense(500, activation="relu", name="ap4")(layer_ap)
    ...
    layer_an = layers.Dense(700, activation="relu", name="an3")(layer_an)
    layer_an = layers.Dense(500, activation="relu", name="an4")(layer_an)
